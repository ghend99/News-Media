  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <div id="news4-article2-article1">
            ...
            <div id="news4-article2-article5">
            <img class="news4-article2-thumbnail" />
            <p class="news4-article2-header webpage-header"></p>
            <p class="news4-article2-description"></p>
          </div>
          <div id="news4-article2-article6">
            <img class="news4-article2-thumbnail" />
            <p class="news4-article2-header webpage-header"></p>
            <p class="news4-article2-description"></p>
          </div>
          <div id="news4-article2-article7">
            <img class="news4-article2-thumbnail" />
            <p class="news4-article2-header webpage-header"></p>
            <p class="news4-article2-description"></p>
          </div>
          <div id="news4-article2-article8">
            <img class="news4-article2-thumbnail" />
            <p class="news4-article2-header webpage-header"></p>
            <p class="news4-article2-description"></p>
          </div>
