...
const getNews5Article1 = function (searchInput) {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <div id="news5-article1-article">
              <p class="news5-article1-header">${data.response.results[28].fields.headline}</p>
              <img class="news5-article1-thumbnail" src="${data.response.results[29].fields.thumbnail}" />
            </div>
            <div id="news5-article1-article">
              <p class="news5-article1-header"></p>
...
//   let url = `https://content.guardianapis.com/search?q=${searchInput}&page-size=32&show-blocks=all&api-key=${apiKey}&show-fields=thumbnail&show-fields=all`;
//   fetch(url)
//     .then((res) => res.json())
//     .then((data) => {
//       news5Article2Container.innerHTML = `
//       <img class="news5-article2-thumbnail" src="${data.response.results[31].fields.thumbnail}" />
//       <p class="news5-article2-header webpage-header">${data.response.results[31].fields.headline}</p>
//       <p class="news5-article2-date webpage-header">${data.response.results[31].webPublicationDate}</p>
//       `;
//     });
// };
