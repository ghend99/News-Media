...
const getNews2Container = function () {
  let url = `https://content.guardianapis.com/search?&show-blocks=all&api-key=${apiKey}&show-fields=all&show-references=all`;
  fetch(url)
    .then((res) => res.json())
    .then((data) => {
      console.log(data);
      ...
      <div id="news2-article1">
            <div id="news2-article1-section1">
              ...
              <p class="news2-article1-author">${data.response.results[0].pillarName}</p>
              
              <img class="news2-article1-thumbnail" src="${data.response.results[1].fields.thumbnail}" />
            </div>
