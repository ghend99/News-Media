      ...
      for (let i = 0; i < data.response.results.length; i++) {
        ...
        <a href="${data.response.results[i].webUrl}" target="_blank">
          <div id="news1-article1" class="news-container">
            <img class="news1-article1-thumbnail news1-thumbnail" src="${data.response.results[i].fields.thumbnail}" />
            <p class="news1-article1-header webpage-header">${data.response.results[i].fields.headline}</p>
          </div>
        </a>
          ...
          <div id="news1-article2" >
            <a href="${data.response.results[i].webUrl}" target="_blank">
              <div id="news1-article2-article1" class="news1-article2 news-container">
                <img class="news1-article2-thumbnail news1-thumbnail" src="${data.response.results[i].fields.thumbnail}" />
                <p class="news1-article2-header webpage-header">${data.response.results[i].fields.headline}</p>
              </div>
            </a>
