...
//         <div id="news1-article2-article1">
...
//         </div>
//         <div id="news1-article2-article2">
//           <img class="news1-article2-thumbnail news1-thumbnail" src="${data.response.results[4].fields.thumbnail}" />
//           <p class="news1-article2-header webpage-header">${data.response.results[3].fields.headline}</p>
//         </div>
//         <div id="news1-article2-article3">
//           <img class="news1-article2-thumbnail news1-thumbnail" src="${data.response.results[4].fields.thumbnail}" />
//           <p class="news1-article2-header webpage-header">${data.response.results[3].fields.headline}</p>
//         </div>
// `;
...
const getNews3Article2 = function (searchInput) {
  ...
  fetch(url)
    ...
    <div id="news3-article2-article2" class="news3-article2">
      <img class="news3-article2-thumbnail news3-thumbnail" src="${data.response.results[20].fields.thumbnail}"  />
      <p class="news3-article2-header webpage-header"></p>
    </div>
    ...
    <div id="news3-article2-article4" class="news3-article2">
              <img class="news3-article2-thumbnail news3-thumbnail" src="${data.response.results[20].fields.thumbnail}" />
              <p class="news3-article2-header"></p>
            </div>
      `;
    });
};
