...
const getNews1Article1 = function (searchInput) {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <img class="news1-article1-thumbnail" src="${data.response.results[4].fields.thumbnail}" />
      <p class="news1-article1-pillar webpage-header">${data.response.results[4].pillarName}</p>
      ...
      <div id="news1-article2">
        <div id="news1-article2-article1">
          <img class="news1-article2-thumbnail" src="${data.response.results[4].fields.thumbnail}" />
...
const getNews1Article3 = function (searchInput) {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <img class="news1-article3-thumbnail" src="${data.response.results[4].fields.thumbnail}" />
    </div>
