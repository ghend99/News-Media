...
// <a href="${data.response.results[10].webUrl}" target="_blank">
...
// <a ${data.response.results[15].webUrl}>
//  <div id="news3-article1" class="news-container">
...
// <a ${data.response.results[16].webUrl}>
// <div id="news3-article1" class="news-container">
...
// <a ${data.response.results[17].webUrl}>
// <div id="news3-article1" class="news-container">
...
// <a ${data.response.results[18].webUrl}>
...
// <a ${data.response.results[19].webUrl}>
...
// <a ${data.response.results[20].webUrl}>
...
const getNews4Article2 = function (searchInput) {
  ...
  fetch(url)
    ...
    <a ${data.response.results[22].webUrl}>
...
<a ${data.response.results[23].webUrl}>
...
const getNews4Article3 = function (searchInput) {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <a ${data.response.results[26].webUrl}>
...
<a ${data.response.results[27].webUrl}>
...
<a ${data.response.results[28].webUrl}>
...
<a ${data.response.results[29].webUrl}>
