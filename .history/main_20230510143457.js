...
const getNews2Container = function () {
  let url = `https://content.guardianapis.com/search?page-size=30&show-blocks=all&api-key=${apiKey}&show-fields=all&show-references=all`;
  fetch(url)
    .then((res) => res.json())
    .then((data) => {
      console.log(data);
      ...
      <div id="news2-article1">
            <div id="news2-article1-section1">
              <p class="news2-article1-header webpage-header">${data.response.results[3].fields.headline}</p>
              <p class="news2-article1-author webpage-header">${data.response.results[3].pillarName}</p>
            ...
            <div id="news2-article1-section2">
              ...
              <div id="news2-article1-section2-article1">
                ...
                <p class="news2-article1-section2-header">${data.response.results[5].fields.headline}</p>
                <p class="news2-article1-section2-author"></p>
              </div>
              <div id="news2-article1-section2-article1">
                <img class="news2-article1-section2-thumbnail" src="${data.response.results[6].fields.thumbnail}"" />
                <p class="news2-article1-section2-header">${data.response.results[6].fields.headline}</p>
                <p class="news2-article1-section2-author"></p>
              </div>
              <div id="news2-article1-section2-article1">
                <img class="news2-article1-section2-thumbnail" src="${data.response.results[7].fields.thumbnail}"" />
                <p class="news2-article1-section2-header">${data.response.results[7].fields.headline}</p>
                <p class="news2-article1-section2-author"></p>
              </div>
            </div>
          </div>
          <div id="news2-article2">
            <div id="news2-article2-article1" class="news2-article">
              <p class="news2-article2-header">${data.response.results[8].fields.headline}</p>
              <p class="news2-article2-date">${data.response.results[8].webPublicationDate}</p>
              <img class="news2-article2-thumbnail" src="${data.response.results[8].fields.thumbnail}" />
            </div>
            ...
            <div id="news2-article2-article4" class="news2-article">
              <p class="news2-article2-header">${data.response.results[2].fields.headline}</p>
              <p class="news2-article2-date">${data.response.results[1].webPublicationDate}</p>
              <img class="news2-article2-thumbnail" src="${data.response.results[1].fields.thumbnail}" />
            </div>
      `;
    });
};
...
const hideNewsHeader = function () {
  if (newsHeaderContainer.style.display === "grid") {
...
const hideSection5 = function () {
  if (section5Container.style.display === "block") {
