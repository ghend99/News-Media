    ...
    .then((data) => {
      ...
      <div id="news2-article1">
            <div id="news2-article1-section1">
              <p class="news2-article1-header">${data.response.results[2].fields.headline}</p>
            ...
            <div id="news2-article1-section2">
              <div id="news2-article1-section2-article1">
                ...
                <p class="news2-article1-section2-header"></p>
                <p class="news2-article1-section2-author"></p>
              </div>
              <div id="news2-article1-section2-article1">
                <img class="news2-article1-section2-thumbnail" src="" />
                <p class="news2-article1-section2-header"></p>
                <p class="news2-article1-section2-author"></p>
              </div>
              <div id="news2-article1-section2-article1">
          ...
          <div id="news2-article2">
            <div id="news2-article2-article1" class="news2-article">
              <p class="news2-article2-header"></p>
              <p class="news2-article2-date"></p>
              <img class="news2-article2-thumbnail" src="" />
            </div>
