...
const newsArticle2Container = document.getElementById("news1-article2-contain");
...
const getNewsArtcle2 = function () {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <p class="news1-article2-header">${data.response.results[0].fields.headline}</p>
            <p class="news1-article2-date"></p>
            <img class="news1-article2-thumbnail" src="" />
            <p class="news1-article2-description"></p>
