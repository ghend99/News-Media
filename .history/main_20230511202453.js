      ...
      <div id="news2-article1">
            ...
            <div id="news2-article1-section2">
              <div id="news2-article1-section2-article1">
                ...
                <p class="news2-article1-section2-header webpage-header">${data.response.results[1].fields.headline}</p>
              ...
              <div id="news2-article1-section2-article1">
                ...
                <p class="news2-article1-section2-header webpage-header">${data.response.results[2].fields.headline}</p>
                <p class="news2-article1-section2-author"></p>
              </div>
              <div id="news2-article1-section2-article1">
                <img class="news2-article1-section2-thumbnail" src="${data.response.results[3].fields.thumbnail}"" />
                <p class="news2-article1-section2-header webpage-header">${data.response.results[3].fields.headline}</p>
                <p class="news2-article1-section2-author"></p>
              </div>
              <div id="news2-article1-section2-article1">
                <img class="news2-article1-section2-thumbnail" src="${data.response.results[4].fields.thumbnail}"" />
                <p class="news2-article1-section2-header webpage-header">${data.response.results[4].fields.headline}</p>
                <p class="news2-article1-section2-author"></p>
              </div>
            </div>
          </div>
          <div id="news2-article2">
            <div id="news2-article2-article1" class="news2-article">
              <p class="news2-article2-header webpage-header">${data.response.results[5].fields.headline}</p>
