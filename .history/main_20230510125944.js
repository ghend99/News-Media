    ...
    .then((data) => {
      ...
      <div id="news2-article1">
            <div id="news2-article1-section1">
              <p class="news2-article1-header webpage-header">${data.response.results[2].fields.headline}</p>
              <p class="news2-article1-author">${data.response.results[3].pillarName}</p>
