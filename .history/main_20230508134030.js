...
const news4ArticleContainer = document.getElementById(
  "news4-article-container"
);
...
const getNews4Article = function () {
  let url = `https://content.guardianapis.com/search?&show-blocks=all&api-key=${apiKey}&show-fields=all`;
  fetch(url)
    .then((res) => res.json())
    .then((data) => {
      news4ArticleContainer.innerHTML = `
      <div id="news4-article-container">
          <div id="news4-article1-container-header">
            <p class="news-article1-header"></p>
          </div>
          <div id="news4-article2-container">
            <div id="news4-article2-article1">
              <img class="news4-article2-thumbnail" src="${data.response.results[0].fields.thumbnail}" />
              <p class="news4-article2-header webpage-header"></p>
              <p class="news4-article2-description"></p>
            </div>
            <div id="news4-article2-article2">
              <img class="news4-article2-thumbnail" src="" />
              <p class="news4-article2-header webpage-header"></p>
              <p class="news4-article2-description"></p>
            </div>
