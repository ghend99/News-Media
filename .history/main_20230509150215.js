...
const btnHide = document.querySelector(".section4-hide");
...
const section3ContainerHide = document.getElementById(
  "news3-container-hide-header"
);
const btnSection3Hide = document.querySelector(".news-section-show-header");
