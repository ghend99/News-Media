  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <a href="${data.response.results[i+6].webUrl}" target="_blank">
        <p class="news-header-title webpage-header">${data.response.results[i+6].fields.headline}</p>
      </a>
      </div>

      <div id="news-headers-section"  class="news-container">
      <a href="${data.response.results[i+7].webUrl}" target="_blank">
        <p class="news-header-title webpage-header">${data.response.results[i+].fields.headline}</p>
      </a>
      </div>

<div id="news-headers-section"  class="news-container news-header3">
<a href="${data.response.results[i+8].webUrl}" target="_blank">
        <p class="news-header-title webpage-header" id="news-header3">${data.response.results[i+8].fields.headline}</p>
      </a>
</div>
