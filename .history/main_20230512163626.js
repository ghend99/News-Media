  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <div id="news1-article1" class="news-container">
        ...
        <img class="news1-article1-thumbnail news1-thumbnail" src="${data.response.results[4].fields.thumbnail}" />
        <p class="news1-article1-header webpage-header">${data.response.results[3].fields.headline}</p>
        <p class="news1-article1-date webpage-header">${data.response.results[9].webPublicationDate}</p>

      </div>
      <div id="news1-article2" class="news-container">
        <div id="news1-article2-article1" class="news1-article2">
          <img class="news1-article2-thumbnail news1-thumbnail" src="${data.response.results[4].fields.thumbnail}" />
          <p class="news1-article2-header webpage-header">${data.response.results[3].fields.headline}</p>
        </div>
        <div id="news1-article2-article2" class="news1-article2">
          <img class="news1-article2-thumbnail news1-thumbnail" src="${data.response.results[4].fields.thumbnail}" />
          <p class="news1-article2-header webpage-header">${data.response.results[3].fields.headline}</p>
        </div>
        <div id="news1-article2-article3" class="news1-article2">
          <img class="news1-article2-thumbnail news1-thumbnail" src="${data.response.results[4].fields.thumbnail}" />
          <p class="news1-article2-header webpage-header">${data.response.results[3].fields.headline}</p>
        </div>
`;
...
const getNews1Article3 = function (searchInput) {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <div id="news1-article3-article1">
      <p class="news1-article3-header webpage-header">${data.response.results[3].fields.headline}</p>
      <img class="news1-article3-thumbnail news1-thumbnail" src="${data.response.results[4].fields.thumbnail}" />
    </div>
    <div id="news1-article3-article2">
      <p class="news1-article3-header webpage-header">${data.response.results[3].fields.headline}</p>
      <img class="news1-article3-thumbnail news1-thumbnail" src="${data.response.results[4].fields.thumbnail}" />
    </div>
...
const getNews3Article2 = function (searchInput) {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <div id="news3-article2-article1" class="news3-article2">
      <img class="news3-article2-thumbnail news3-thumbnail" src="${data.response.results[20].fields.thumbnail}" />
      <p class="news3-article2-header webpage-header">${data.response.results[12].fields.headline}</p>
    </div>
    <div id="news3-article2-article2" class="news3-article2">
      <img class="news3-article2-thumbnail news3-thumbnail" src="${data.response.results[20].fields.thumbnail}"  />
      <p class="news3-article2-header webpage-header">${data.response.results[12].fields.headline}</p>
    </div>
    <div id="news3-article2-article3" class="news3-article2">
      <img class="news3-article2-thumbnail news3-thumbnail" src="${data.response.results[20].fields.thumbnail}" />
      <p class="news3-article2-header webpage-header">${data.response.results[12].fields.headline}</p>
    </div>
    <div id="news3-article2-article4" class="news3-article2">
      <img class="news3-article2-thumbnail news3-thumbnail" src="${data.response.results[20].fields.thumbnail}" />
      <p class="news3-article2-header webpage-header">${data.response.results[12].fields.headline}</p>
            </div>
      `;
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <div id="news4-article2-article1">
              <img class="news4-article2-thumbnail news4-thumbnail" class="news4-article2" src="${data.response.results[20].fields.thumbnail}"/>
            ...
            <div id="news4-article2-article2">
              <img class="news4-article2-thumbnail news4-thumbnail" class="news4-article2" src="${data.response.results[21].fields.thumbnail}" />
...
<div id="news4-article3-article1">
              <img class="news4-article3-thumbnail news4-thumbnail" src="${data.response.results[24].fields.thumbnail}" />
            ...
            <div id="news4-article3-article2">
              <img class="news4-article3-thumbnail news4-thumbnail" src="${data.response.results[25].fields.thumbnail}"  />
