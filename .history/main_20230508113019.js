...
const getNewHeaders = function () {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <p class="news-header webpage-header">${data.response.results[0].fields.headline}</p>
      <p class="news-header webpage-header">${data.response.results[0].fields.headline}</p>
      <p class="news-header webpage-header" id="news-header3">${data.response.results[0].fields.headline}</p>
      <p class="news-header webpage-header" id="news-header4">${data.response.results[0].fields.headline}</p>
      `;
    });
};
