...
const getNews5Article1 = function () {
  ...
  fetch(url)
    ...
    .then((data) => {
      ...
      <p class="news5-article1-header webpage-header">${data.response.results[8].fields.headline}</p>
      <p class="news5-article1-date webpage-header"></p>
      <img class="news5-article-thumbnail" src="" />
      <p class="news5-article1-description"></p>
`;
    });
};
